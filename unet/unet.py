...
def main():
    parser = argparse.ArgumentParser(description='Classify DVS Gesture with U-Net SNN')
    parser.add_argument('-T', default=16, type=int, help='simulating time-steps')
    parser.add_argument('-device', default='cuda', help='device')
    parser.add_argument('-b', default=4, type=int, help='batch size')  # 适当减小批次大小以适应显存
    ...
    parser.add_argument('-out-dir', type=str, default='/home/dell/171990/SNNs train/out H1/res', help='root dir for saving logs and checkpoint')
    parser.add_argument('-resume', type=str, default='/home/dell/171990/SNNs train/out H1/res/T16_b4_adam_lr0.0016_c64_unet/checkpoint_max.pth', help='resume from the checkpoint path')
    ...
    parser.add_argument('-lr', default=0.0016, type=float, help='learning rate')
    parser.add_argument('-channels', default=64, type=int, help='channels of CSNN')  # 适当减小通道数以适应显存
